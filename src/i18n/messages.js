const messages = {
  uz: {
    ...
    testPage: {
      ...
      submitConfirmYes: 'Ha',
      // ProfileGateModal — the name/phone check before a test starts (TEMP while
      ...
      phoneValidation: 'Iltimos, telefon raqamini to‘g‘ri kiriting (+998 XX XXX XX XX).',
  ...
  ru: {
    ...
    testPage: {
      ...
      phoneValidation: 'Пожалуйста, введите корректный номер телефона (+998 XX XXX XX XX).',
