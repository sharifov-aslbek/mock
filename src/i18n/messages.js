const messages = {
  uz: {
    ...
    testPage: {
      ...
      profileDescription: 'Testni boshlashdan oldin shaxsiy ma’lumotlarni to‘ldiring.',
      firstName: 'First Name',
      lastName: 'Last Name',
      fatherName: 'Father Name',
      profileStart: 'Testni boshlash',
  ...
  ru: {
    ...
    testPage: {
      ...
      profileDescription: 'Заполните личные данные перед началом теста.',
      firstName: 'First Name',
      lastName: 'Last Name',
      fatherName: 'Father Name',
      profileStart: 'Начать тест',
