<template>
  <section class="bg-white py-20 px-4 sm:px-6 lg:px-8">
    <div class="max-w-6xl mx-auto">
      ...
      <div class="bg-gray-100 rounded-2xl overflow-hidden shadow-lg aspect-video flex items-center justify-center">
        <span class="text-gray-500 text-lg">Dashboard Preview</span>
      </div>
    </div>
  </section>
</template>